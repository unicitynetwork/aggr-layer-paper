...
\begin{table*}[h!]
\centering
\caption{Comparison of zero-knowledge proof technologies for compression of non-deletion proofs. The Plonky3 AIR rows are measured on the reference implementation~\cite{rsmtair} (10-core Apple M1 ``Pro'', batch size 4096, $\sim$116 conjectured soundness bits); the remaining rows are taken from earlier experiments referenced in the text.}
