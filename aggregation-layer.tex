...
\[
  M_q = \{\,k \mapsto v \in M \mid q \sqsubseteq k\,\}
\]
...
\begin{enumerate}[nosep,label=(\roman*)]
  ...
  \]
  If $p\not\sqsubseteq k$, accept iff this is the final entry. If $p\sqsubseteq k$, require $p=k[0..d)$ and another entry, set $q=c^{k[d]}$, and continue.
